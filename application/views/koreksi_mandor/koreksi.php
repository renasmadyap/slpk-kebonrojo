...
$id_koreksi = $pu_dn['id_pu_dn'];
$mitra_id = $pu_dn['mitra_id'];
$nama_mitra=mysqli_query($con,"select * from mitra m JOIN pu_dn dn ON m.id_mitra = dn.mitra_id WHERE dn.mitra_id = '$mitra_id' and dn.id_pu_dn = '$id_koreksi'");
?>
<script>
function sum(){
            ...
            <div class="card-body">
				...
				<div class="row form-group">
                    ...
                    <div class="col-md-9">
                        ...
                        <input value="<?= set_value('mitra', $pu_dn['mitra_id']); ?>" name="mitra" id="mitra" type="hidden" readonly="readonly" class="form-control" placeholder="Nama Mitra...">
                        <?php endforeach; ?>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <input value="<?= set_value('jadwal_pu', $pu_dn['jadwal_pu']); ?>" name="jadwal_pu" id="jadwal_pu" readonly="readonly" type="number" class="form-control" placeholder="Jadwal PU KE...">
