        ...
        <div class="card shadow-sm border-bottom-danger">
            ...
            <div class="card-body">
				...
				<div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <input value="<?= set_value('tgl_masuk', $mandor_koreksiln['tgl_masuk']); ?>" name="tgl_masuk" readonly="readonly" id="tgl_masuk" type="date" class="form-control time" placeholder="Tanggal Masuk...">
