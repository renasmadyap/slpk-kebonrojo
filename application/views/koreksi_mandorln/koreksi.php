...
$id_koreksiln = $pu_ln['id_pu_ln'];
$mitra_id = $pu_ln['mitra_id'];
$nama_mitra=mysqli_query($con,"select * from mitra m JOIN pu_ln mkln ON m.id_mitra = mkln.mitra_id WHERE mkln.mitra_id = '$mitra_id' and mkln.id_pu_ln = '$id_koreksiln'");
?>
<script>
function sum(){
                ...
                <div class="row">
                    <div class="col">
                        <h4 class="h5 align-middle m-0 font-weight-bold text-danger">
                            Form Koreksi Data P.U Luar Negri
                        </h4>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body">
				...
				<div class="row form-group">
                    ...
                    <div class="col-md-9">
                        ...
                        <input value="<?= set_value('mitra', $pu_ln['mitra_id']); ?>" name="mitra" id="mitra" type="hidden" readonly="readonly" class="form-control" placeholder="Nama Mitra...">
                        <?php endforeach; ?>
				...
				<div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <input value="<?= set_value('tgl_masuk', date('Y-m-d')); ?>" name="tgl_masuk" readonly="readonly" id="tgl_masuk" type="date" class="form-control time" placeholder="Tanggal Masuk...">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <input value="<?= set_value('jadwal_pu', $pu_ln['jadwal_pu']); ?>" name="jadwal_pu" id="jadwal_pu" readonly="readonly" type="number" class="form-control" placeholder="Jadwal PU KE...">
