        ...
        <div class="card shadow-sm border-bottom-danger">
                ...
                <div class="row">
                    <div class="col">
                        <h4 class="h5 align-middle m-0 font-weight-bold text-danger">
                            Form Detail Data P.U
                        </h4>
                    </div>
                    <div class="col-auto">
                        <a href="<?= base_url('admindn') ?>" class="btn btn-sm btn-secondary btn-icon-split">
                            <span class="icon">
            ...
            <div class="card-body">
				...
				<div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <input value="<?= set_value('tgl_masuk', $pu_dn['tgl_masuk']); ?>" name="tgl_masuk" readonly="readonly" id="tgl_masuk" type="text" class="form-control time" placeholder="Tanggal Masuk...">
