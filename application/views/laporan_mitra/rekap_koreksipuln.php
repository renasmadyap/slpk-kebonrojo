        ...
        <div class="row">
            <div class="col">
                <h4 class="h5 align-middle m-0 font-weight-bold text-danger">
                    Rekap Data Koreksi Luar Negeri (Berdasarkan Mitra)
                </h4>    
    ...
    <div class="table-responsive">
        <table class="table table-striped w-100 nowrap" id="dataTable">
            ...
            <tbody>
                ...
                from mandor_koreksiln INNER JOIN mitra ON mandor_koreksiln.mitra_id = mitra.id_mitra WHERE tgl_masuk BETWEEN '$from' AND '$end' group by mitra_id");
