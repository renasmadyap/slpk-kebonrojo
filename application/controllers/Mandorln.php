...
class Mandorln extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->load('templates/dashboard', 'mandor_ln/data', $data);
    }
	...
	public function detail($getId)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->template->load('templates/dashboard', 'mandor_ln/detail', $data);
        } else {
        }
    }
