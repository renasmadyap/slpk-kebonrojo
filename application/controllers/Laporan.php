    ...
    private function _cetak($data, $table_)
    {
        ...
        */ 
        ...
        if ($table_ == 'mandor_koreksi') :
            $data['title'] = "Laporan";
            $this->template->load('templates/dashboard', 'laporan/rekap_koreksipudn', $data);
            ...
            $data['title'] = "Laporan";
            $this->template->load('templates/dashboard', 'laporan/rekap_koreksipuln', $data);
			/*$pdf->SetFont('Arial', 'B', 10);
            $pdf->Cell(10, 7, 'No.', 1, 0, 'C');
            $pdf->Cell(20, 7, 'Tgl Input', 1, 0, 'C');
            ...
            elseif ($table_ == 'pu_dn') :
            $data['title'] = "Laporan";
            $this->template->load('templates/dashboard', 'laporan/rekap_pudn', $data);
			/*$pdf->Cell(10, 7, 'No.', 1, 0, 'C');
            $pdf->Cell(20, 7, 'Tgl Input', 1, 0, 'C');
            $pdf->Cell(40, 7, 'Nama Petugas', 1, 0, 'C');
            $pdf->Cell(40, 7, 'Mitra', 1, 0, 'C');
            ...
            */
                ...
                $data['title'] = "Laporan";
                $this->template->load('templates/dashboard', 'laporan/rekap_puln', $data);
        endif;
