...
class Admindn extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->load('templates/dashboard', 'admin_dn/data', $data);
    }
	...
	public function detail($getId)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->template->load('templates/dashboard', 'admin_dn/detail', $data);
        } else {
        }
    }
}